//current date and hour variable
...
//Function for date and time on homepage
...
//Help storing what we write in each time block and store locally
function initPage() {
...
//Color code the time blocks for past, future, and present CSS file.
function background () {
...
$(document).ready(function(){
  initPage()
  background()
// Buttons that save to localstorage
